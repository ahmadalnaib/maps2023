...
<html>
<head>
    <title>Ihr Lockport-Informations</title>
    <style>
...
<body>
    <div  class="container">
        ...
        <div class="data">{{__('download.Personal data')}}</div>
            ...
            <div class="invoice-details">
              <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Anlage Adresse:</td>
                        <td>{{$rental->system->place->address}}</td>
                    </tr>
                    <tr>
                        <td>Buchungs-Periode:</td>
            ...
            @endforeach
              ...
              <div class="footer">
                <p>Wir wünschen dir einen schönen Tag!<br>
                    Bei Fragen zur Anlagennutzung oder zur Rechnung kannst du dich gerne bei uns melden <br>
                    Impressum <br>
                    Betreiber Buchungsportal, Anwenderbetreuung / Betrieb und Wartung der Anlagen, Aussteller der<br>
                    Rechnung:<br>
                    Locktec GmbH <br>
