...
<div class="mb-6">
    ...
    @enderror
            ...
            <button type="submit" class="text-white bg-slate-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-5">{{__('policy.Update')}}</button>
        </form>
    </div>
</x-admin>
