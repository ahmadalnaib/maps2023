<x-admin>
    ...
    <div class="container my-12 mx-auto md:px-12 p-5">
        ...
        <form class="form-contact" action="{{route('admin.boxtype.update',$type)}}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-col-2 gap-4">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input type="radio" name="big" value="1" class="form-radio text-blue-500 focus:ring-blue-300 focus:border-blue-500" {{ $type->big ? 'checked' : '' }}>
                           <span class="ml-2">{{__('type.Big')}}</span>
                        </label>
                        <label class="inline-flex items-center ml-6">
                            <input type="radio" name="big" value="0" class="form-radio text-blue-500 focus:ring-blue-300 focus:border-blue-500" {{ !$type->big ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input type="radio" name="ebike_option" value="1" class="form-radio text-blue-500 focus:ring-blue-300 focus:border-blue-500" {{ $type->ebike_option ? 'checked' : '' }}>
                            <span class="ml-2">{{__('type.With Electric Charge')}}</span>
                        </label>
                        <label class="inline-flex items-center ml-6">
                            <input type="radio" name="ebike_option" value="0" class="form-radio text-blue-500 focus:ring-blue-300 focus:border-blue-500" {{ !$type->ebike_option ? 'checked' : '' }}>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <label class="inline-flex items-center">
                            <input type="radio" name="first_floor_option" value="1" class="form-radio text-blue-500 focus:ring-blue-300 focus:border-blue-500" {{ $type->first_floor_option ? 'checked' : '' }}>
                           <span class="ml-2">{{__('type.First Floor')}}</span>
                        </label>
                        <label class="inline-flex items-center ml-6">
                            <input type="radio" name="first_floor_option" value="0" class="form-radio text-blue-500 focus:ring-blue-300 focus:border-blue-500" {{ !$type->first_floor_option ? 'checked' : '' }}>
                ...
                <button type="submit" class="text-white bg-indigo-500 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-5">{{__('type.Update')}}</button>
            </div>
        </form>
    </div>
</x-admin>
