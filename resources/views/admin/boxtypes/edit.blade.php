    ...
    <div class="container my-12 mx-auto md:px-12 p-5">
        ...
        <form class="form-contact" action="{{route('admin.boxtype.update',$type)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid grid-col-2 gap-4">
                ...
                <button type="submit" class="text-white bg-red-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-5">{{__('type.Update')}}</button>
            </div>
        </form>
    </div>
</x-admin>
