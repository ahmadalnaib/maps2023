...
<div class="container">
    <div class="row justify-content-center">  
        <div id="success" style="display: none" class="col-md-8 text-center h3 p-4 bg-success text-light rounded">The payment success  </div> 
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Pay with card</div>
