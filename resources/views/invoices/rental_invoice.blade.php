...
<body>
    <div class="invoice-container">
        <div class="invoice-section">
            <div class="section-right">
               ...
               <div>
                <h4>LockTec GmbH </h4>
                <h4>Schließfächer & Sicherheitssysteme</h4>
                <p>Johann-Georg-Herzog-Str. 19 </p>
                <p>D-96369 Weissenbrunn</p>
                <p>Telefon: +49 9261 6075 90</p>
                <p>Telefax: +49 9261 6075 10</p>
                <p>info@locktec.com</p>
                <p>www.locktec.com</p>
            ...
            <div class="section-left">
                <h4>LockTec GmbH, D-96369 Weissenbrunn-Hummendorf</h4>
                <p>{{$rental->user->name}}</p>
                <p>{{$rental->user->street}} {{$rental->user->street_number}}</p>
                <p> {{$rental->user->postcode}} {{$rental->user->city}}</p>
                <p></p>
            </div>
        </div>
      ...
      <div>
        ...
        <p><span class="text-bold">Buchung-Nr:</span> <span class="">{{ $rental->id}}</span> vom {{ \Carbon\Carbon::parse($rental->start_time)->tz('Europe/Berlin')->format('Y-m-d H:i:s') }}</p>
        <p><span class="text-bold">Produktbezeichnung:</span>{{$rental->duration}}</p>
        ...
        <p><span class="text-bold">Leistungszeitraum:</span>{{ \Carbon\Carbon::parse($rental->start_time)->tz('Europe/Berlin')->format('Y-m-d H:i:s') }} - {{ \Carbon\Carbon::parse($rental->end_time)->tz('Europe/Berlin')->format('Y-m-d H:i:s') }}</p>
  ...
  <div class="invoice-section2">
    <div class="section-left2">
        <p>USt.-Ident.-Nr. DE 812326429</p>
        <p>Steuer-Nr. 212/118/91243</p>      
    </div>
    <div class="section-right2">
        <p>Amtsgericht Coburg HRB 2742</p>
        <p>Geschäftsführer: Johannes Clausen</p>     
    </div>
</div>
  <div>
