<div class="bg-gray-100 border shadow-md rounded-lg px-4 py-6">
    <div class="flex justify-between items-center">
        <h4 class="text-black font-medium">{{__('admin.Users')}}</h4>
    ...
    <div class="text-3xl text-black font-bold mt-4">{{$usersCount }}</div>
